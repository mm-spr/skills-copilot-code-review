...
initial_announcements = [
    {
        ...
        "title": "Spring Showcase Signups",
        "message": "Activity registration for the Spring Showcase closes next Friday. Reserve student spots early for the best schedule options.",
        "start_date": None,
